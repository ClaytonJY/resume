...
\begin{document}
\name{CLAYTON YOCHUM \hspace{2.7in} Machine Learning Engineer}
...
\begin{resume}
  ...
  \begin{tabular}{p{4.6in} l}
    {\bf Senior Machine Learning Engineer, MLOps} & \emph{April 2023 - December 2025} \\
    \href{https://www.abridge.com/}{\it Abridge}        & \emph{Remote}               \\
    Early engineer at leading healthcare AI startup
  \end{tabular}
  \vspace{2pt}
  \begin{itemize}\itemsep -2pt
    \item Built a massive speech-to-text system transcribing 4+ hours of audio per second
    \item Developed a singular API service consolidating access to all ML functionality across company
    \item Managed thousands of GPUs across multiple SKUs in a GCP \& GKE environment
    \item Introduced new tools including Temporal, NVIDIA Triton, TensorRT-LLM, uv, Pydantic, FastAPI
    \item Created a unique CI/CD process to support dozens of engineers in a monorepo
    \item Lead incident response and post-mortems for our most severe service outages
    \item Mentored junior engineers across teams in software development and deployment practices
  \end{itemize}
  ...
  \begin{itemize}\itemsep -2pt
    ...
    \item Created internal python packages enabling more robust pipelines
  ...
  \begin{tabular}{p{4.6in} l}
    ...
    \href{https://everactive.com/}{\it Everactive}             & \emph{Ann Arbor, MI}         \\
  ...
  \begin{itemize}\itemsep -2pt
    ...
    \item Wrote AWS ECS services \& python libraries for automated failure detection from sensor data
  ...
  \begin{itemize}\itemsep -2pt
    ...
    \item Contributed technical content to company blog (/href{https://www.r-bloggers.com/2018/07/a-tour-of-timezones-troubles-in-r/}{example})
  ...
  \begin{itemize}\itemsep -2pt
    ...
    \item Created R packages and Shiny applications to predict data center capacity needs
  \end{itemize}
